...
{
    /// <summary>
    /// Unit tests for the UpdateOccupationalRiskAdministratorEmailRequest validation rules covering required fields, length constraints, format validation, and boundary conditions.
    /// </summary>
