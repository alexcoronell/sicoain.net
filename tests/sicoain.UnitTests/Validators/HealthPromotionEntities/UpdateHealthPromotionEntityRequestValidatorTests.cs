...
{
    /// <summary>
    /// Unit tests for the UpdateHealthPromotionEntityRequest validation rules covering required fields, length constraints, format validation, and boundary conditions.
    /// </summary>
